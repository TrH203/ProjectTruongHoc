...
namespace ProjectTruongHoc
{
    public partial class frm_QuanLySinhVien : Form
    {
        ...
        {
            string sql = "Update ThongTienSinhVien Set " +
            ...
            dataGridView1.DataSource = l.capnhapData("ThongTienSinhVien");
        }

        private void button1_Click(object sender, EventArgs e)
        {
            string sql = "INSERT INTO ThongTienSinhVien " +
        ...
        {
            string sql = "Delete from ThongTienSinhVien where MaSinhVien = '" +
                                txt_masv.Text + "';";
            MessageBox.Show(sql);
