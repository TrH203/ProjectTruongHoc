...
namespace ProjectTruongHoc
{
    ...
    {
        string connect_string = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Nguyen\source\repos\ProjectTruongHoc\ProjectTruongHoc\Database1.mdf;Integrated Security=True";
        SqlConnection conn;
        public LOPDUNGCHUNG()
        {
